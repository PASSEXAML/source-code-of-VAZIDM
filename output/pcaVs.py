...
# 载入数据
ae_pca_path = '../result/PRJEB13870/PCA/ae_pca_values.tsv'
gan_pca_path = '../result/PRJEB13870/PCA/gan_pca_values.tsv'
vae_pca_path = '../result/PRJEB13870/PCA/vae_pca_values.tsv'
